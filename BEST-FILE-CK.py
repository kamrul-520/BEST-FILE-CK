...
logo = (f"""
{W}      _  __    _    __  __ ____  _   _ _     
{G}| |/ /   / \  |  \/  |  _ \| | | | |    
{W}| ' /   / _ \ | |\/| | |_) | | | | |    
{G}| . \  / ___ \| |  | |  _ <| |_| | |___ 
{W}|_|\_\/_/   \_\_|  |_|_| \_\\___/|_____|{G}/{W}GIFT
{W}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{vb} TOOL WONER {vcv} KAMRUL{G}-{W}BOSS
...
#-_-_-_-_-_-_-_-<-FILE-MENU->-_-_-_-_-_-_-_-#
    def _F_i_L_e_(self):
    	...
    	if _P_a_S_ == "1":
    	    ...
    	    self.plist.append("first1122")
    	    self.plist.append("firstlast")
    	    self.plist.append("first@@@")
    	    self.plist.append("first12")
    	    self.plist.append("firstlast123")
    	    self.plist.append("first000")
    	    self.plist.append("0987654")
    	    self.plist.append("@1234@")
    	    self.plist.append("1@2@3@")
    	    self.plist.append("@@@@####")
    	    self.plist.append("@@@###")
    	    self.plist.append("first123123")
    	    self.plist.append("first222")
